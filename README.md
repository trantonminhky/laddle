# Laddle - Because Wordle is not enough
<center>
 <img src='assets/images/comic_0036.png' width='50%' />
</center>
...
# How to play
- &uarr; - Menu move up/Move row up
- &darr; - Menu move down/Move row down
- Enter - Select
- Backspace - Delete

# Installation
Choose the latest release in the Releases section of this repo. <b>The game is only runnable on Linux.</b> Simply run `./laddle` and it would (hopefully) run.